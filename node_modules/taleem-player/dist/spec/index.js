  ...
  deck: [
    ...
    },
    {
      ...
      data: [
        {
          name: "left",
          content: "taleem-browser shows one complete slide at a time. Each slide appears fully, clear, and ready to read.",
          showAt: 10
        },
        {
          name: "right",
          content: "taleem-player shows content gradually, like a video. Ideas appear step by step as the lesson moves forward.",
          showAt: 12
        }
      ]
    },
    ...
    },
    {
      ...
      data: [
        { name: "card", icon: "\u{1F9E0}", label: "Focus", showAt: 60 },
        { name: "card", icon: "\u{1F4D8}", label: "Clarity", showAt: 61 },
        { name: "card", icon: "\u23F1\uFE0F", label: "Pace", showAt: 62 },
        { name: "card", icon: "\u{1F3AF}", label: "Understanding", showAt: 63 }
      ]
    },
    {
      type: "eq",
