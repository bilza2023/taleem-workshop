// node_modules/taleem-core/dist/taleem-core.esm.js
...
var MOBILE_UNSAFE_SLIDES = /* @__PURE__ */ new Set([
  "twoColumnText",
  "table",
  "barChart",
  "donutChart"
]);
var TaleemBuilder = class {
  constructor({ mode = "desktop" } = {}) {
    ...
    SLIDE_TYPES.forEach((type) => {
      this[type] = (end, data, options = {}) => this.#addSlide(type, end, data, options);
    });
  }
  /* ────── metadata ────── */
  addDetails(meta) {
...
// src/index.js
var index_default = TaleemBuilder;
export {
